...
async def call_mcp_tool(request: MCPToolRequest):
    ...
    print(f"Received request: server_nickname='{request.server_nickname}', tool_name='{request.tool_name}', json_arguments='{request.json_arguments}'")

    # Hardcoded dummy JSON response
    return {
        "success": True,
